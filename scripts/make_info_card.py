...
# ===========================================================================
HOST = "rahul"   # shown as  rahul@github  in the header

ROWS = [
    ("host",),
    ("kv", "Role", "React Native Dev @ Banao Technologies"),
    ("kv", "Project", "Vidya — AI EdTech platform (V3 owner)"),
    ("kv", "Edu", "B.Tech, Computer Engineering"),
    ("kv", "Based", "Surat, Gujarat, India"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React Native, TypeScript, React Query"),
    ("kv", "State", "Zustand, hierarchical query keys"),
    ("kv", "APIs", "Axios, S3 presigned URLs, WebSockets"),
